...
<body>
  <div class="sidebar text-bg-dark">
    <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; height: 970px;">
      <a href="<?= BASEURL; ?>/mainmenu" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none text-center">
        <img src="../public/asset/logo.png" class="ms-2 mt-5" width="auto" height="60">
      </a>
      <span class="fs-4 text-center">-{ <?= $data['tier']; ?> }-</span>
      <hr>
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
          <a href="<?= BASEURL; ?>/mainmenu" class="nav-link active" aria-current="page">
  ...
  <div class="container">
    ...
    <div class="d-flex flex-row-reverse">
      ...
      <div class="col-md-3 fs-4 float-start">
        <span>EXP : <?= $data['user']['tierpoin'] ?>P</span>
      </div>
      <div class="col-md-3 fs-4 float-start">
        <span>Tier Point : <?= $data['user']['tierpoin'] ?>P</span>
      </div>
    </div>
    <div class="sekolah mt-5">
      <div class="row">
        <?php foreach ($data['bangunan'] as $bangunan) : ?>
          <div class="col">
            <div class="card itemschool" style="width: 17rem;">
              <div class="card-header text-center"><?= $bangunan['bangunan']; ?></div>
              <div class="card-body d-flex justify-content-center">
                <img src="asset/<?= $bangunan['icon']; ?>" width="200px" height="auto" class="card-image-top" alt="">
              </div>
              <?php if (array_key_exists($bangunan['idbangunan'], $data['rampok'])) : ?>
                <a href="<?= BASEURL; ?>/rampok/<?= $data['rampok'][$bangunan['idbangunan']]; ?>" class="text-decoration-none text-reset">
                  <div class="card-footer card-link text-center">
                    <strong>CURI</strong>
                  </div>
                </a>
              <?php endif; ?>
